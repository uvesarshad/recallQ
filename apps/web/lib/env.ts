...
const envSchema = z.object({
  ...
  // Comma-separated additional audiences the mobile OAuth-exchange endpoint
  // will accept beyond the web client IDs (e.g. iOS bundle id for Apple,
  // iOS/Android client IDs for Google).
  OAUTH_ALLOWED_GOOGLE_AUDIENCES: z.string().min(1).optional(),
  OAUTH_ALLOWED_APPLE_AUDIENCES: z.string().min(1).optional(),
  ...
  STRIPE_PRICE_STARTER_YEARLY_ID: z.string().min(1).optional(),
  STRIPE_PRICE_PRO_YEARLY_ID: z.string().min(1).optional(),
