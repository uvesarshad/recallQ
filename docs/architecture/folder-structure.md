...
- apps/: One folder per deployable app.
  ...
  - apps/extension: Chrome extension via WXT. Created in Stage 8 of [PLAN.md](file:///e:/Projects/recallQ/PLAN.md).
  - apps/mobile: Expo iOS/Android app. Created in Stage 9 of [PLAN.md](file:///e:/Projects/recallQ/PLAN.md).
- packages/: Internal TypeScript packages consumed by apps. Created in Stage 1 of [PLAN.md](file:///e:/Projects/recallQ/PLAN.md) (api-schema, api-client, core).
